...
Pop culture is full of depictions of 'AI going rogue'. The quotation above is from a book published in 1992 but the concept is at least a decade older (think of Skynet). [Since the beginning of the current 'AI' boom](https://slate.com/technology/2019/02/openai-gpt2-text-generating-algorithm-ai-dangerous.html) companies have been invoking the idea of an artificial superintelligence becoming a danger to humanity and [lately](https://www.bbc.com/news/articles/c14dpgm0rg4o) some tech CEOs brought up the topic again.
